...
* Last Modified time: 2017-06-14 11:01:07
*----------------------------------------------------------------------------*/
#ifndef MODEL_H
#define MODEL_H
...
enum class model_id {
  UNDEFINED, HUBBARD, HUBBARD_NBAND, TJ, BHZ, PYROCHLORE,
  HUBBARD_SQIRIDATE
};

/*
enum class model_id2 {
  UNDEFINED, HUBBARD, HUBBARD_NBAND, TJ, BHZ, KM, PYROCHLORE, HUBBARD_SQIRIDATE
};
*/
...
public:
  ...
  bool have_parameter(const std::string& pname) const;
  ...
  virtual const std::string& signature_str(void) const { return signature_str_; }
  virtual const std::string& info_str(void) const { return info_str_; }
