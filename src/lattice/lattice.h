...
enum class lattice_id {
  UNDEFINED, SQUARE, SQUARE_2BAND, SQUARE_T2G, CHAIN, HONEYCOMB, SIMPLECUBIC, FCC, 
  FCC_TYPE3, KAGOME, PYROCHLORE_V1, PYROCHLORE_3D, SQUARE_NBAND, CUBIC_NBAND, 
  SQUARE_IRIDATE, TBG, NICKELATE_2L
};
